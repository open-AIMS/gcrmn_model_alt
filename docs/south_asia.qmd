...
for (catg in cats) {
  ...
  ##   mutate(wt = Area / sum(Area)) |>
    ...
    cat(paste0("Change in ", catg, " cover (%) for each Subregion depicted 
       ...
       based on Bayesian exceedence probabilities (no bars: P < 0.85 (no evidence),
       one bar: P < 0.90 (weak evidence), two bars: P < 0.95 (evidence), 
       three bars: P < 1.00 (strong evidence), four bars P = 1.00).
       \n")) 
    cat(":::\n\n")
